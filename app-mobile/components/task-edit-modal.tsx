...
type EditTaskModalProps = {
  ...
  loading: boolean;
  onSave: () => void;          // calls updateExistingTask in parent
  onRequestClose: () => void;  // parent sets visible=false & clears editingTask
};
