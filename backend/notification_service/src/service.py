...
class NotificationsService:
    def __init__(self, notifications_db: NotificationDB):
    ...
    async def get_notification(self, notification_id: str, getter:UserInDB) -> Notification:
    ...
    async def get_users_unread_notification_ids(self, user_id: str, getter:UserInDB, max_items: int, continuation_token: str | None) -> tuple[list[str], str | None]:
