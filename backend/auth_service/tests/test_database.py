...
class TestCreateUser:
    ...
    async def test_create_user_success(
        self, auth_db, mock_container, sample_user_create, sample_user_auth_info
    ):
    ...
    async def test_create_user_already_exists(
        self, auth_db, mock_container, sample_user_create
    ):
...
class TestGetUserAuthById:
    ...
    async def test_get_user_by_id_success(
        self, auth_db, mock_container, sample_user_auth_info
    ):
