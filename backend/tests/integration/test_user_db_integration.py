...
from backend.models.user import UserInDB, UserUpdate
...
class TestUsersDBOperations:
    ...
    async def test_create_user_success(
        ...
        result = await UsersDB(container=mock_cosmos_container).create_user(sample_user_create)
    ...
    async def test_create_user_duplicate(
        ...
        with pytest.raises(UserExistsError):
            await UsersDB(container=mock_cosmos_container).create_user(sample_user_create)
        mock_cosmos_container.create_item.assert_called_once()
    ...
    async def test_get_user_by_id_success(
        ...
        result = await UsersDB(container=mock_cosmos_container).get_user_by_id(sample_user_in_db.id)
    ...
    async def test_get_user_by_id_not_found(self, mock_cosmos_container, mock_user_db):
        ...
        with pytest.raises(UserNotFoundError):
            await UsersDB(container=mock_cosmos_container).get_user_by_id("non-existent-id")
        mock_cosmos_container.read_item.assert_called_once()
    ...
    async def test_get_user_by_username_success(
        ...
        result = await UsersDB(container=mock_cosmos_container).get_user_by_username(sample_user_in_db.username)
    ...
    async def test_get_user_by_username_not_found(
        ...
        with pytest.raises(UserNotFoundError):
            await UsersDB(container=mock_cosmos_container).get_user_by_username("nonexistent")
        mock_cosmos_container.query_items.assert_called_once()
    ...
    async def test_get_user_by_email_success(
        ...
        result = await UsersDB(container=mock_cosmos_container).get_user_by_email(sample_user_in_db.email)
    ...
    async def test_get_user_by_email_not_found(
        ...
        with pytest.raises(UserNotFoundError):
            await UsersDB(container=mock_cosmos_container).get_user_by_email("user@nonexistent.com")
        mock_cosmos_container.query_items.assert_called_once()
    ...
    async def test_update_user_correct_id(
        ...
        result = await UsersDB(container=mock_cosmos_container).update_user(sample_user_update)
    ...
    async def test_update_user_email(
        ...
        result = await UsersDB(container=mock_cosmos_container).update_user(sample_user_update_email)
    ...
    async def test_update_user_username(
        ...
        result = await UsersDB(container=mock_cosmos_container).update_user(sample_user_update_username)
    ...
    async def test_update_user_password(
        ...
        result = await UsersDB(container=mock_cosmos_container).update_user(sample_user_update_password)
        ...
        assert (
            result.hashed_password
            != sample_user_in_db.hashed_password
        )
        mock_cosmos_container.read_item.assert_called_once()
    ...
    async def test_update_user_change_active(
        ...
        result = await UsersDB(container=mock_cosmos_container).update_user(sample_user_update_active)
    ...
    async def test_update_user_change_superuser(
        ...
        result = await UsersDB(container=mock_cosmos_container).update_user(sample_user_update_superuser)
    ...
    async def test_delete_user_success(
        self, mock_cosmos_container, sample_user
    ):
    ...
    async def test_delete_user_not_found(self, mock_cosmos_container, mock_user_db):
        ...
        with pytest.raises(UserNotFoundError):
            await UsersDB(container=mock_cosmos_container).delete_user("non-existent-id")
        mock_cosmos_container.delete_item.assert_called_once()
